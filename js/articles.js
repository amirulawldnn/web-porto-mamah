/**
 * articles.js â€” Content Source for Bu Khusnul Khotimah's Educational Blog
 * =========================================================================
 ...
 *   title       â€” Full article title
 *   slug        â€” URL-friendly identifier (lowercase, hyphens)
 *   coverImage  â€” Path to the cover image (relative to root)
 *   category    â€” Display category name (e.g. "Algebra", "Geometry")
 *   catClass    â€” CSS class for badge color (cat-algebra, cat-geometry, etc.)
 *   author      â€” Author display name
 *   publishDate â€” ISO 8601 date string (YYYY-MM-DD)
 *   readingTime â€” Estimated reading time string
 *   excerpt     â€” Short 1â€“2 sentence summary shown in card previews
 *   tags        â€” Array of tag strings for filtering
 *   featured    â€” Boolean. Only one article should be featured: true
 *   popular     â€” Boolean. Mark up to 3 articles as popular sidebar items
 *   latest      â€” Boolean. Mark articles to appear in the "Latest" column
 *   content     â€” Full HTML content rendered inside the article reader modal
 */
...
const ARTICLES = [
  {
    ...
    content: `
      ...
      <p>Geometry is not merely a branch of mathematics. It is a language for reading the world. Once a student learns to see it, they never stop seeing itâ€”in a spider's web, a honeycomb, a cathedral window, or the screen they are reading these words on.</p>
    `
  },
  {
    id: 'art-002',
    ...
    content: `
      ...
      <p>Instead of jumping to symbolic manipulation, we start with a balance scale. If two bags of marbles and three single marbles balance eleven single marbles, students visually remove three from both sides. This makes the core algebraic ruleâ€”<em>doing the same to both sides</em>â€”instantly intuitive.</p>
      ...
      <p>Framing equations around genuine scenariosâ€”calculating savings goals for a video game, comparing mobile data plansâ€”makes abstract formulas meaningful. When students understand <em>why</em> the equation exists, solving it becomes purposeful.</p>
    `
  },
  {
    id: 'art-003',
    ...
    latest: true,
    content: `
      <p>Fractions are among the most commonly cited sources of anxiety for Grade 7 students. The solution is not more drillâ€”it is genuine visual understanding that replaces the need to memorize rules that feel arbitrary.</p>
      ...
      <p>Once students see fractions spatially, operations become consequences of what they understand rather than rules they are obeying. That shiftâ€”from compliance to comprehensionâ€”is the heart of genuine mathematical confidence.</p>
    `
  },
  {
    id: 'art-004',
    ...
    latest: false,
    content: `
      <p>In our data-saturated digital world, statistical literacy may be the most practical mathematical skill a student can develop. Middle schoolers encounter graphs dailyâ€”on social media, in sports coverage, in political reportingâ€”and very few are taught to question what they see.</p>
      ...
      <p>Students study truncated Y-axes, inconsistent intervals, and cherry-picked time ranges. They become data detectivesâ€”looking for what is hidden as much as what is shown. This is one of the most engaged my classes ever become.</p>
  ...
  },
  {
    ...
    content: `
      ...
      <p>When a problem is marked wrong, do not simply erase it. Write down <em>why</em> it was wrongâ€”was it a calculation slip, a sign error, or a conceptual gap?â€”then redo it step-by-step. This notebook becomes an invaluable personal study guide before every exam.</p>
      ...
      <p>The Pomodoro techniqueâ€”25 minutes of focused work followed by a 5-minute restâ€”prevents cognitive fatigue and maintains concentration across longer study sessions. Mathematics requires full attention; these blocks protect it.</p>
  ...
  },
  {
    ...
    latest: true,
    content: `
      <p>Gamification does not mean making mathematics easier. It means making the effort feel worthwhile in a different way. When students work together to unlock an escape-room using algebraic clues, the mathematical thinking required is rigorousâ€”but the experience feels like an adventure.</p>

      <h3>How a Math Escape Room Works</h3>
      <p>Students work in small groups. Each correct answer reveals a code or unlocks the next clue. The sequence of problems is designed so that earlier solutions are building blocks for later onesâ€”requiring genuine understanding, not just isolated calculation.</p>
      ...
      <p>A classroom escape room does not require special equipment. A set of envelopes, numbered locks, and a sequence of problems is enough. The design that matters most is in the mathematical structure of the cluesâ€”which is, of course, exactly our area of expertise.</p>
    `
  }
];
